...
class CreateImportDetalleFacturas extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('import_detalle_facturas', function (Blueprint $table) {
            $table->id();
            $table->foreignId('factura_id')->constrained('import_facturas');
    ...
    {
        Schema::dropIfExists('import_detalle_facturas');
    }
}
