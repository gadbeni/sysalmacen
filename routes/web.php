...
Route::group(['prefix' => 'admin', 'middleware' => 'loggin'], function () {
   ...
   //........................  EGRES
    ...
    Route::get('people_ext/print/report', [PeopleExtController::class, 'print'])->name('people_ext.print');
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('users/{user}/historial', [UserController::class, 'historial'])->name('users.historial');
