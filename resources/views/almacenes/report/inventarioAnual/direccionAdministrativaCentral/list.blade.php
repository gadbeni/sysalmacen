            ...
            <table id="dataTableStyle" style="width:100%"  class="table table-bordered table-striped table-sm">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" style="text-align: center">DIRECCION ADMINISTRATIVA</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>1</td>
                        <td style="text-align: left">{{ $directionEspecific->nombre }}</td>
                        <td style="text-align: right">{{number_format($si,2,',', '.')}}</td>
