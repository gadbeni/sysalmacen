# Documentación de SYSALMACEN

Sistema de gestión de almacenes del Gobierno Autónomo Departamental del Beni (GOBE).
Administra inventario de materiales, ingresos por compra, egresos, donaciones (SEDEGES),
solicitudes de pedido entre unidades y reportes anuales, sobre múltiples almacenes (sucursales).
